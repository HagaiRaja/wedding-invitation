    ...
    <>
      ...
      >
        ...
        <div className="relative">
          ...
          >
            <p className={cn(dancingScript.className)}>Resepsi Pernikahan</p>
        ...
        <AnimateOnScroll>
          <div className="relative flex items-center justify-center py-5 flex-col w-full">
            ...
            <p className="text-center text-black px-4">
              Bergabunglah dengan kami untuk perayaan di
              <br />
              <span className="font-bold text-gray-700">
                Sekar Jambu, Kota Denpasar
              </span>
              <br />
              — pada — <br />{" "}
              <span className="font-bold text-gray-700">
              ...
              <br />{" "}
              Harap tiba tepat waktu, Grand Entrance pengantin saat sunset
              <br />{" "}
              <span className="font-underline">
              Pakaian: Pastel (Kecuali Pink)
              </span>
              <br />
            </p>
