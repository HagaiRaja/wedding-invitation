      ...
      <AnimateOnScroll>
          ...
          <div className="px-4 pt-5 pb-0 space-y-4">
            <p className="text-center leading-5 text-black">
              Please pray and share your best wishes for us 💌
              <br /><br />{" "}
              ...
              If you prefer a gift, please feel free to surprise us in your own special way!
              <br />{" "}<br />{" "}
              God bless you.
            </p>
            <br />{" "}
          ...
          <div className="flex flex-row space-x-4 justify-center pl-1 pr-1">
            <div className="border border-gray-400 bg-white rounded p-4 flex flex-row justify-center leading-normal bank-div w-2/4" onClick={() => copyClipboard("BCA account number", "7725420226")}>
            ...
            <div className="border border-gray-400 bg-white rounded p-4 flex flex-row justify-center leading-normal bank-div w-2/4" onClick={() => copyClipboard("BNI account number", "0772462762")}>
              <div className="flex items-center">
          ...
          <div className="flex flex-row space-x-4 justify-center mt-2 pl-1 pr-1">
            <div className="border border-gray-400 bg-white rounded p-4 flex flex-row justify-center leading-normal bank-div w-2/4" onClick={() => copyClipboard("Mandiri account number", "1050018423180")}>
              <div className="flex items-center">
            ...
            <div className="border border-gray-400 bg-white rounded p-4 flex flex-row justify-center leading-normal bank-div w-2/4" onClick={() => copyClipboard("Woori account number", "1002662380779")}>
              <div className="flex items-center">
